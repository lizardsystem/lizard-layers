...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ParameterType.measuring_rod'
        db.delete_column('lizard_layers_parametertype', 'measuring_rod_id')


    def backwards(self, orm):
        
        # Adding field 'ParameterType.measuring_rod'
        db.add_column('lizard_layers_parametertype', 'measuring_rod', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_measure.MeasuringRod'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 18, 10, 41, 11, 808340)'}),
