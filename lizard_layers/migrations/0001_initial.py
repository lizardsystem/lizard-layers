...
class Migration(SchemaMigration):
    depends_on = (
        ("lizard_area", "0018_auto__add_arealink"),
    )

    def forwards(self, orm):
        
        # Adding model 'ValueType'
        db.create_table('lizard_layers_valuetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ))
        db.send_create_signal('lizard_layers', ['ValueType'])

        # Adding model 'AreaValue'
        db.create_table('lizard_layers_areavalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_area.Area'], null=True, blank=True)),
            ('value_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_layers.ValueType'], null=True, blank=True)),
            ('value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('lizard_layers', ['AreaValue'])


    def backwards(self, orm):
        
        # Deleting model 'ValueType'
        db.delete_table('lizard_layers_valuetype')

        # Deleting model 'AreaValue'
        db.delete_table('lizard_layers_areavalue')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 6, 11, 43, 11, 101267)'}),
