...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ParameterType'
        db.create_table('lizard_layers_parametertype', (
        ...
        db.send_create_signal('lizard_layers', ['ParameterType'])


    def backwards(self, orm):
        
        # Deleting model 'ParameterType'
        db.delete_table('lizard_layers_parametertype')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 8, 14, 9, 18, 495217)'}),
