...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AreaValue.comment'
        db.alter_column('lizard_layers_areavalue', 'comment', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))


    def backwards(self, orm):
        
        # Changing field 'AreaValue.comment'
        db.alter_column('lizard_layers_areavalue', 'comment', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 28, 15, 14, 17, 22805)'}),
