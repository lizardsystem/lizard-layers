...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaValue.object_information'
        db.add_column('lizard_layers_areavalue', 'object_information', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AreaValue.object_information'
        db.delete_column('lizard_layers_areavalue', 'object_information')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 5, 16, 33, 29, 7098)'}),
        ...
        'lizard_layers.areavalue': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'flag': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_information': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'lizard_layers.parametertype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'measuring_rod_code': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
