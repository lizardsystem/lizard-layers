...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParameterType.measuring_rod_code'
        db.add_column('lizard_layers_parametertype', 'measuring_rod_code', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParameterType.measuring_rod_code'
        db.delete_column('lizard_layers_parametertype', 'measuring_rod_code')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 18, 10, 37, 0, 680421)'}),
