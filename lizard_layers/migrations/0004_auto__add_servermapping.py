...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ServerMapping'
        db.create_table('lizard_layers_servermapping', (
            ...
            ('external_server', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('relative_path', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ))
        db.send_create_signal('lizard_layers', ['ServerMapping'])


    def backwards(self, orm):
        
        # Deleting model 'ServerMapping'
        db.delete_table('lizard_layers_servermapping')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 20, 15, 11, 1, 47942)'}),
